        ...
        <form action="{{ route('order.preview') }}" method="POST" enctype="multipart/form-data" class="bg-[#f8f9fa] p-8 rounded-2xl shadow space-y-10">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="phone" required class="w-full border rounded p-2 bg-white" value="{{ old('phone') }}">
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block font-semibold text-[#0A3D62]">Masa Berlaku STNK <span class="text-red-500">*</span></label>
                        <input type="date" name="stnk_date" required class="w-full border rounded p-2 bg-white" value="{{ old('stnk_date') }}">
                    </div>
